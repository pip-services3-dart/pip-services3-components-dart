...
class CredentialParams extends ConfigParams {
    ...
    CredentialParams([dynamic values = null]):super(values) {
    }
    ...
    static List<CredentialParams> manyFromConfig(ConfigParams config) {
        List<CredentialParams> result = List<CredentialParams>();
    ...
    static CredentialParams fromConfig(ConfigParams config)  {
        List<CredentialParams> credentials = CredentialParams.manyFromConfig(config);
